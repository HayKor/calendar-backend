...
class RefreshTokensUseCase(
    ...
    suspend operator fun invoke(refreshToken: Uuid, userIp: String, userAgent: String): Auth {
        val session = authSessionRepository.updateAuthSession(
            refreshToken, UpdateSessionParams(
